...
# SettingWithCopyWarning removed in pandas 3.x

if len(sys.argv)==2:
    user_path = sys.argv[1]
    snp_path = os.path.join(_SCRIPT_DIR, 'data/snp_df.csv')
    geno_path = os.path.join(_SCRIPT_DIR, 'data/geno_df.csv')
...
# a little data cleanup (pandas 3.x compatible)
df.loc[df['mag'] == "", 'mag'] = "0"
df.loc[df["repute"] == "", "repute"] = "neutral"
...
# read the template
with open(os.path.join(_SCRIPT_DIR, "variant_template.html"), "r") as f:
    template = f.read()
